...
| **Comment word cloud** | Nuvem de Palavras | `CommentsViewComponent` (por vídeo/canal), `VideosViewComponent` (global, todos os comentários); Engage `GET .../comments/word-cloud` |
